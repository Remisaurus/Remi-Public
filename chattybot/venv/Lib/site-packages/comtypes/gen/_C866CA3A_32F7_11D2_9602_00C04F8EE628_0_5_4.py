...
__all__ = [
    'SP_VISEME_9', 'SpFileStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SPRuleId',
    'DISPID_SGRSTPropertyId', 'SREAllEvents', 'SRCS_Disabled',
    'ISpObjectTokenCategory', 'DISPID_SWFEExtraData',
    'DISPID_SpeechGrammarRule', 'ISpeechLexiconPronunciations',
    'SPAO_NONE', 'DISPID_SPIElements', 'SpUnCompressedLexicon',
    'DISPID_SpeechPhraseRules', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCEventInterests', 'SVP_11', 'SVEViseme', 'SREPrivate',
    'DISPID_SGRName', 'IEnumString', '_RemotableHandle',
    'SpCustomStream', 'SPCT_COMMAND', 'SPDKL_CurrentConfig',
    'SWTDeleted', 'SPADAPTATIONRELEVANCE', 'DISPID_SGRId',
    'ISpeechAudioFormat', 'DISPID_SRSAudioStatus', 'STCAll',
    'ISpeechPhraseRule', 'SAFTCCITT_uLaw_22kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SREAdaptation',
    'DISPID_SRCERequestUI', 'SASClosed', 'DISPID_SVResume',
    'STSF_CommonAppData', 'SpeechDisplayAttributes',
    'SWPKnownWordPronounceable', 'DISPID_SPRs_NewEnum',
    ...
    'DISPID_SpeechPhoneConverter', 'SpeechMicTraining',
    'DISPID_SWFEChannels', 'ISpeechPhraseElement',
    'SAFTExtendedAudioFormat', 'SPSERIALIZEDRESULT',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRAudioInput',
    'DISPID_SREmulateRecognition', 'SPPS_RESERVED2',
    'SAFT24kHz16BitMono', 'SAFTGSM610_22kHzMono', 'SPEI_PHRASE_START',
    'SPSTREAMFORMATTYPE', 'STSF_AppData', 'DISPID_SVSpeak',
    'DISPID_SDKSetStringValue', 'SPRULE', 'SAFT48kHz8BitMono',
    'ISpDataKey', 'SP_VISEME_13', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVGetVoices', 'DISPID_SVSLastBookmark',
    'DISPID_SPPs_NewEnum', 'SDTAlternates', 'DISPIDSPRG',
    'STCLocalServer', 'SGRSTTTextBuffer', 'DISPID_SOTCGetDataKey',
    'SpSharedRecognizer', '_ISpeechVoiceEvents',
    'DISPID_SPELexicalForm', 'SPLEXICONTYPE',
    'DISPID_SDKGetBinaryValue', 'ISpPhraseAlt',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPILanguageId',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPRules_NewEnum',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SOTId',
    'DISPID_SVSLastBookmarkId', 'DISPID_SOTDataKey',
    'SVSFUnusedFlags', 'SGLexical', 'SAFT44kHz16BitStereo',
    'SPINTERFERENCE_TOOSLOW', 'ISpAudio', 'SECFIgnoreKanaType',
    'SAFT16kHz16BitStereo', 'SPVISEMES', 'ISpeechMemoryStream',
    'SLTApp', 'eLEXTYPE_PRIVATE20', 'DISPID_SGRSTText',
    'DISPID_SABufferNotifySize', 'SPDKL_DefaultLocation',
    'ISpeechBaseStream', 'ISpSerializeState', 'DISPID_SGRs_NewEnum',
    'SAFTADPCM_22kHzMono', 'SAFT8kHz16BitStereo', 'DISPID_SBSSeek',
    'DISPID_SGRsFindRule', 'SPEI_END_INPUT_STREAM',
    'ISpeechRecoResultTimes', 'SPEI_SR_RETAINEDAUDIO',
    'SSFMOpenForRead', 'SVSFIsXML', 'SGRSTTEpsilon', 'SVEBookmark',
    'ISpEventSource', 'SVP_7', 'DISPID_SRGetRecognizers',
    'SpeechRecoProfileProperties', 'DISPID_SGRSTRule',
    'DISPID_SpeechPhraseAlternates', 'SPBOOKMARKOPTIONS',
    'ISpShortcut', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPWORDPRONUNCIATION', 'tagSPTEXTSELECTIONINFO', 'SVP_1',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechPropertyComplexResponseSpeed',
    'SpTextSelectionInformation', 'SRESoundEnd',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_5', 'SITooLoud',
    'DISPID_SABIBufferSize', 'eLEXTYPE_PRIVATE9',
    'SAFTCCITT_ALaw_8kHzMono', 'SPAUDIOBUFFERINFO',
    'DISPID_SRCERecognition', 'SPCATEGORYTYPE', 'eLEXTYPE_PRIVATE3',
    'DISPID_SPEDisplayText', 'SINone', 'SVSFParseSapi',
    'ISpeechPhoneConverter', 'SRSEIsSpeaking', 'SVP_10',
    'SPPHRASERULE', 'DISPID_SLPSymbolic', 'DISPID_SPRsItem',
    'DISPID_SPAsCount', 'SPINTERFERENCE_NOISE', 'ISpeechPhraseRules',
    ...
    'SGPronounciation', 'DISPID_SGRsCommitAndSave',
    'ISpeechPhraseElements', 'DISPID_SVEAudioLevel', 'ISpMMSysAudio',
    'DISPID_SpeechGrammarRuleState', 'SVP_8', 'SPPS_Function',
    'DISPID_SpeechPhraseRule', 'SPAR_High', 'ISpXMLRecoResult',
    'DISPID_SPCLangId', 'SREHypothesis', 'SRAONone',
    'SDKLDefaultLocation', 'DISPID_SLPLangId', 'DISPID_SASState',
    'DISPID_SPRNumberOfElements', 'DISPID_SPPsItem',
    'SAFTGSM610_8kHzMono', 'eLEXTYPE_PRIVATE17',
    'SPTEXTSELECTIONINFO', 'DISPID_SLGetPronunciations',
    'SPEI_WORD_BOUNDARY', 'ISpResourceManager', 'SPPS_Noncontent',
    'eLEXTYPE_PRIVATE13', 'SPBINARYGRAMMAR', 'ISpRecoResult',
    'ISpeechVoice', 'ISpStream', 'DISPID_SVVoice', 'SVP_14',
    'DISPID_SGRsItem', 'SAFT11kHz8BitStereo', 'ISpPhrase',
    'SPWT_DISPLAY', 'DISPID_SFSClose', 'DISPID_SLWWord',
    'IInternetSecurityMgrSite', 'IEnumSpObjectTokens',
    'DISPID_SRCEFalseRecognition', 'tagSPPROPERTYINFO',
    'SpeechFormatType', 'DISPID_SGRAddResource', 'SPFM_CREATE_ALWAYS',
    'SPAO_RETAIN_AUDIO', 'SP_VISEME_21', 'DISPID_SPRuleName',
    'DISPID_SOTCDefault', 'SECFDefault', 'SPSHT_EMAIL', 'SGRSTTRule',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SVSInputWordPosition',
    'SDTReplacement', 'SAFTADPCM_8kHzMono', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SLGetWords', 'eLEXTYPE_PRIVATE18',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SGRsAdd',
    'SPWORDPRONUNCIATIONLIST', 'SPPS_NotOverriden', 'SITooFast',
    'eLEXTYPE_PRIVATE6', 'SAFT48kHz16BitMono', 'DISPID_SRRTLength',
    'DISPID_SRCESoundEnd', 'DISPID_SCSBaseStream', 'SPPS_Unknown',
    'SDA_No_Trailing_Space', 'SDA_One_Trailing_Space',
    'DISPID_SpeechVoiceEvent', 'ISpVoice', 'SpeechTokenKeyFiles',
    'SRARoot', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    ...
    'DISPID_SGRSTType', 'SpInProcRecoContext', 'SVESentenceBoundary',
    'DISPID_SRCPause', 'DISPID_SWFESamplesPerSec',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechCategoryRecoProfiles',
    'DISPID_SLWType', 'DISPID_SVEPhoneme',
    'DISPID_SRCRequestedUIType', 'SPGRAMMARSTATE',
    'DISPID_SPEActualConfidence', 'DISPID_SPIAudioStreamPosition',
    'SPSUnknown', 'SSSPTRelativeToCurrentPosition',
    'ISpeechObjectTokenCategory', 'DISPID_SpeechPhraseElements',
    'DISPID_SVESentenceBoundary', 'DISPID_SPEsCount',
    'DISPID_SRSetPropertyNumber', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechAllElements', 'SAFT48kHz8BitStereo', 'SAFTText',
    'SP_VISEME_1', 'SpeechDictationTopicSpelling', 'DISPID_SPAsItem',
    'SPPS_SuppressWord', 'SECLowConfidence', 'ISpeechRecognizer',
    'ISpRecognizer', 'SpeechRecoEvents', 'SVEPrivate',
    'DISPID_SVAlertBoundary', 'SGDSInactive',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechRecoResultTimes',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechCustomStream',
    'ISpeechTextSelectionInformation', 'SPEI_SR_AUDIO_LEVEL',
    'SPSSuppressWord', 'ISpStreamFormatConverter',
    'SAFT22kHz8BitMono', 'DISPID_SPRulesItem', 'SpeechVoiceEvents',
    'SECNormalConfidence', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SAStatus', 'SPSMF_SAPI_PROPERTIES',
    ...
    'DISPID_SWFEFormatTag', 'SP_VISEME_8',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPRECOCONTEXTSTATUS', 'SPRST_INACTIVE',
    'DISPID_SRRDiscardResultInfo', 'DISPIDSPTSI_SelectionOffset',
    'SECFIgnoreWidth', 'DISPID_SDKOpenKey',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRGDictationSetState',
    'DISPID_SRRTTickCount', 'LONG_PTR', 'DISPID_SpeechObjectToken',
    'SpeechEmulationCompareFlags', 'SpStreamFormatConverter',
    'ISpeechGrammarRuleState', 'DISPID_SLPType', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCEAdaptation', 'eLEXTYPE_LETTERTOSOUND',
    'eLEXTYPE_USER_SHORTCUT', 'SPEI_END_SR_STREAM',
    ...
    'SPWORDPRONOUNCEABLE', 'SAFTCCITT_ALaw_22kHzMono',
    'eLEXTYPE_PRIVATE15', 'SPDKL_CurrentUser', 'SRATopLevel',
    'SPAUDIOSTATE', 'SpeechEngineConfidence', 'SPVPRI_OVER',
    'SpeechTokenKeyAttributes', 'SPFM_OPEN_READWRITE',
    'DISPID_SpeechPhraseProperties', 'DISPID_SABIMinNotification',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SLWLangId', 'eLEXTYPE_APP',
    'SGRSTTWord', 'ISpeechDataKey', 'SPPHRASEELEMENT',
    'SSSPTRelativeToEnd', 'DISPID_SVEVoiceChange', 'SpeechWordType',
    'DISPID_SAFType', 'SPEVENTENUM', '_ISpeechRecoContextEvents',
    'SPSFunction', 'DISPID_SPRText', 'SAFT24kHz8BitStereo',
    'DISPID_SDKSetBinaryValue', 'ISpeechAudioBufferInfo',
    'SVF_Emphasis', 'ISpeechVoiceStatus',
    'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechPhraseReplacements', 'SPPHRASE',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SBSWrite', 'ISpProperties',
    'DISPID_SOTDisplayUI', 'SLOStatic', 'SVSFPersistXML',
    'DISPID_SpeechWaveFormatEx', 'SVSFDefault',
    'DISPID_SPRuleEngineConfidence', 'SpeechTokenContext',
    'SRERequestUI', 'SpeechStreamFileMode', 'SPPS_Interjection',
    'SREPhraseStart', 'DISPID_SVSVisemeId',
    'DISPID_SRGCmdLoadFromResource', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVEWord', 'SPSNoun', 'Speech_StreamPos_Asap',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPPEngineConfidence',
    'DISPID_SGRSTWeight', 'SPCT_SUB_COMMAND', 'DISPID_SPCIdToPhone',
    'ISpPhoneConverter', 'DISPID_SPEDisplayAttributes',
    'SpWaveFormatEx', 'DISPID_SpeechAudio', 'SSTTDictation',
    'SPPARTOFSPEECH', 'DISPID_SVGetAudioOutputs', 'SVSFParseMask',
    ...
    'DISPID_SVGetProfiles', 'SPLO_DYNAMIC', 'SpeechTokenShellFolder',
    'DISPID_SVPause', 'DISPID_SRGId', 'DISPID_SRCRetainedAudio',
    'SPSEMANTICERRORINFO', 'SRERecoOtherContext',
    'SpeechAddRemoveWord', 'SpInprocRecognizer', 'SRSActiveAlways',
    'SPWORDTYPE', 'SPPS_RESERVED1', 'DISPID_SPEAudioStreamOffset',
    'SFTSREngine', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechRecognizer', 'DISPID_SPRuleConfidence', 'SpLexicon',
    'eLEXTYPE_PRIVATE16', 'SREPropertyStringChange',
    'DISPID_SPPsCount', 'DISPID_SpeechObjectTokenCategory',
    'SP_VISEME_3', 'SPEI_PHONEME', 'SVP_17', 'DISPID_SDKEnumKeys',
    'ISpNotifySource', 'SpeechAudioState', 'eWORDTYPE_DELETED',
    'SpMMAudioEnum', 'ISpStreamFormat', 'Speech_Max_Word_Length',
    'DISPID_SFSOpen', 'DISPID_SpeechGrammarRuleStateTransition',
    'SGLexicalNoSpecialChars', 'DISPID_SRGRecoContext',
    'DISPID_SRRAudioFormat', 'DISPID_SDKDeleteKey',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechPhraseInfo',
    'SpeechAudioFormatType', 'ISpeechPhraseAlternate', 'DISPID_SPPId',
    'DISPID_SLRemovePronunciation', 'SLODynamic',
    'ISpeechGrammarRule', 'ISpObjectToken', 'SPSHT_NotOverriden',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_PRIVATE1', 'SPEI_INTERFERENCE',
    'SPSModifier', 'ISpObjectWithToken', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechMMSysAudio', 'SAFTCCITT_uLaw_11kHzMono', 'SSTTWildcard',
    'SPSMF_UPS', 'DISPID_SRCState', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCEStartStream',
    'SPWT_PRONUNCIATION', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPXMLRESULTOPTIONS',
    'DISPID_SRGCmdLoadFromMemory', 'SDTDisplayText',
    'SAFTCCITT_ALaw_8kHzStereo', 'SDKLCurrentUser',
    'DISPID_SMSAMMHandle', 'DISPID_SPEPronunciation',
    'ISpeechFileStream', 'SpeechVisemeFeature', 'SSFMCreate',
    'DISPID_SMSALineId', 'SRTStandard', 'DISPID_SPRulesCount',
    'SPSEMANTICFORMAT', 'SVPAlert', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRSAddWordTransition',
    'SVP_3', 'SAFTGSM610_44kHzMono', 'SpSharedRecoContext',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SRTExtendableParse', 'SVSFParseSsml', 'SpMemoryStream',
    'SpObjectToken', 'SITooQuiet', 'SPEI_RESERVED3', 'SPPROPERTYINFO',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SLWPronunciations',
    'SVEVoiceChange', 'SpNullPhoneConverter', 'SPWAVEFORMATTYPE',
    'SWTAdded', 'SAFTCCITT_uLaw_11kHzStereo', 'SAFT12kHz16BitMono',
    'SPRULESTATE', 'DISPID_SVPriority', 'SRAImport', 'SPRST_ACTIVE',
    'SPDATAKEYLOCATION', 'SPRS_INACTIVE',
    'SDA_Consume_Leading_Spaces', 'SVSFPurgeBeforeSpeak',
    'ISpeechXMLRecoResult', 'DISPID_SLGenerationId', 'SVEAllEvents',
    'DISPID_SBSRead', 'DISPID_SRCVoice', 'DISPID_SAVolume',
    'eLEXTYPE_RESERVED10', 'SpeechRegistryLocalMachineRoot',
    'SPAUDIOOPTIONS', 'SAFT22kHz16BitMono', 'SPLO_STATIC',
    'SDKLLocalMachine', 'DISPID_SGRClear', 'DISPID_SLPPhoneIds',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SOTMatchesAttributes',
    'SpeechInterference', 'ISpeechObjectTokens', 'SPRECOSTATE',
    'SPEI_MAX_TTS', 'DISPID_SRCResume', 'SWPUnknownWordPronounceable',
    'DISPID_SAFSetWaveFormatEx', 'SpNotifyTranslator',
    'ISpeechRecoResult', 'SPEI_VISEME',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCCreateGrammar',
    'DISPID_SRGRules', 'DISPID_SPPFirstElement',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRCEPhraseStart',
    'SAFT16kHz8BitStereo', 'DISPID_SRRTStreamTime',
    'DISPID_SMSSetData', 'SREFalseRecognition', 'DISPID_SVSkip',
    'DISPID_SPERequiredConfidence', 'SpeechPropertyAdaptationOn',
    'SPCT_DICTATION', 'SPGS_DISABLED', 'SPFM_NUM_MODES', 'SVP_9',
    'DISPID_SRGetFormat', 'SP_VISEME_12', 'SPSHT_OTHER',
    'DISPID_SpeechRecoContext', 'DISPID_SAFGuid',
    'DISPID_SVEEnginePrivate', 'DISPID_SLGetGenerationChange',
    'DISPID_SRGDictationLoad', 'SDTPronunciation',
    'DISPID_SGRsDynamic', 'SPAS_PAUSE', 'SRADynamic', 'SPAS_CLOSED',
    'ISpeechResourceLoader', 'SPEI_TTS_PRIVATE', 'ISpRecoCategory',
    'DISPID_SGRAddState', 'SPCS_DISABLED', 'SAFT16kHz16BitMono',
    'SVP_2', 'SDA_Two_Trailing_Spaces', 'SpCompressedLexicon',
    'SRSInactive', 'SPRST_NUM_STATES', 'DISPID_SGRSRule',
    'DISPID_SPPConfidence', 'SpeechTokenKeyUI',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVEStreamEnd',
    'SPRS_ACTIVE', 'SAFT22kHz16BitStereo', 'SREPropertyNumChange',
    'SSSPTRelativeToStart', 'DISPID_SRCEEnginePrivate',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVRate',
    'SP_VISEME_0', 'SP_VISEME_17', 'DISPID_SOTCSetId',
    'DISPID_SOTCategory', 'SPEI_RESERVED6', 'SPGS_EXCLUSIVE',
    'DISPIDSPTSI', 'SPLOADOPTIONS', 'SpShortcut', 'SREBookmark',
    'ISpPhoneticAlphabetConverter', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechObjectToken', 'SAFTADPCM_44kHzMono',
    'SAFTCCITT_ALaw_11kHzMono', '__MIDL_IWinTypes_0009',
    'SpeechWordPronounceable', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRGIsPronounceable', 'SSTTTextBuffer',
    'DISPID_SVWaitUntilDone', 'SP_VISEME_7', 'SAFTNonStandardFormat',
    'SECHighConfidence', 'SAFT32kHz8BitStereo', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechLexicon', 'SpeechCategoryAudioIn',
    'DISPID_SPIReplacements', 'DISPID_SRStatus',
    'DISPID_SRSSupportedLanguages', 'SVSFVoiceMask',
    'DISPID_SLPsCount', 'SPEI_RECOGNITION', 'eWORDTYPE_ADDED',
    'DISPID_SOTGetDescription', 'SGSDisabled', 'DISPID_SPEsItem',
    'SPEI_MIN_SR', 'SREStateChange', 'SPSInterjection',
    'SpeechCategoryPhoneConverters', 'DISPID_SASCurrentSeekPosition',
    'SPFM_OPEN_READONLY', 'SVP_19', 'SDTRule',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechDataKey', 'SVP_0', 'DISPIDSPTSI_SelectionLength',
    'SAFT24kHz8BitMono', 'SSFMCreateForWrite', 'SREInterference',
    'ISpNotifyTranslator', 'ISpeechRecoGrammar',
    'ISpeechPhraseAlternates', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPPChildren', 'SVP_12', 'SASRun', 'SPRECORESULTTIMES',
    'SpeechGrammarState', 'SpeechGrammarTagWildcard', 'SVP_21',
    'SPVPRIORITY', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SRCAudioInInterferenceStatus', 'SRTSMLTimeout',
    'DISPID_SRCSetAdaptationData', 'ISpGrammarBuilder',
    'ISpRecoContext', 'DISPID_SMSADeviceId', 'ISpeechCustomStream',
    'SPBO_PAUSE', 'SpeechRecognizerState', 'DISPID_SPAPhraseInfo',
    'SpObjectTokenCategory', 'ISpeechWaveFormatEx',
    'SpeechVoiceSpeakFlags', 'SP_VISEME_19',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPIStartTime',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechPhraseAlternate',
    ...
    'SpeechRegistryUserRoot', 'SGRSTTWildcard', 'ISpeechLexiconWord',
    'DISPID_SPPParent', 'DISPID_SRRSaveToMemory',
    'IInternetSecurityManager', 'DISPID_SAFGetWaveFormatEx',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTDefault', 'SP_VISEME_6',
    'DISPID_SDKDeleteValue', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPPS_RESERVED4', 'DISPID_SVDisplayUI',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRSCurrentStreamNumber',
    'SPPS_Verb', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPRuleNumberOfElements', 'SP_VISEME_20',
    'SRSInactiveWithPurge', 'SAFT44kHz16BitMono',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPIAudioSizeTime',
    'DISPID_SASetState', 'DISPID_SRProfile', 'DISPID_SPIEngineId',
    'SVEAudioLevel', 'DISPID_SVVolume', 'DISPIDSPTSI_ActiveOffset',
    'STCInprocHandler', 'DISPID_SRRRecoContext', 'SVSFIsFilename',
    'DISPID_SLPPartOfSpeech', 'SPEI_MAX_SR', 'eLEXTYPE_RESERVED7',
    'SPBO_TIME_UNITS', 'SpeechVoicePriority', 'eLEXTYPE_RESERVED6',
    'DISPID_SRCESoundStart', 'DISPID_SRCEPropertyNumberChange',
    'SECFIgnoreCase', 'SPEI_RECO_OTHER_CONTEXT', 'ISpRecoGrammar2',
    ...
    'SECFNoSpecialChars', 'SBOPause', 'SPEVENTSOURCEINFO',
    'SPEI_REQUEST_UI', 'DISPID_SPAs_NewEnum', 'SP_VISEME_16',
    'WAVEFORMATEX', 'ISpeechLexicon', 'SpeechBookmarkOptions',
    'DISPID_SpeechLexiconWords', 'SREStreamStart', 'SpStream',
    'SAFT11kHz16BitStereo', 'ISpRecognizer3', 'SpeechAudioProperties',
    'DISPID_SPRsCount', 'SVSFIsNotXML', 'DISPID_SpeechAudioFormat',
    'DISPID_SOTIsUISupported', 'DISPID_SDKGetStringValue',
    'SPEI_RESERVED1', 'SP_VISEME_2', 'SAFT11kHz16BitMono', 'SVP_16',
    'ISpeechRecognizerStatus', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPEAudioTimeOffset', 'SRSActive',
    'DISPID_SVSInputSentencePosition', 'SpeechGrammarTagDictation',
    'ISpeechLexiconWords', 'SVP_6', 'SPSNotOverriden',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCEEndStream',
    'ISpRecoGrammar', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechLexiconWord', 'DISPID_SPIGetText',
    'DISPID_SpeechMemoryStream', 'eLEXTYPE_RESERVED4', 'SpVoice',
    'SP_VISEME_4', 'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTSetId',
    'SDTAudio', 'DISPID_SpeechFileStream',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLWsItem', 'SPGS_ENABLED',
    'DISPID_SVSpeakStream', 'DISPID_SRCEInterference',
    'DISPID_SRRSpeakAudio', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPIEnginePrivateData', 'SpeechPropertyResourceUsage',
    'DISPID_SGRSTPropertyName', 'eLEXTYPE_USER', 'SLTUser', 'SPSLMA',
    'DISPID_SGRSTPropertyValue', 'SAFTCCITT_ALaw_11kHzStereo',
    'SP_VISEME_14', 'SPEI_SOUND_END', 'SPEI_RESERVED5',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SADefaultFormat', 'SVSFNLPSpeakPunc',
    'SpeechPropertyHighConfidenceThreshold', 'SVP_18',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVAudioOutput',
    'SPAUDIOSTATUS', 'SpeechRecoContextState', 'DISPID_SpeechVoice',
    'SPEI_UNDEFINED', 'SpeechVisemeType', 'DISPID_SOTRemove',
    ...
    'eLEXTYPE_PRIVATE14', 'SPSHORTCUTPAIR', 'SVPNormal',
    'SRAInterpreter', 'SINoSignal', 'SAFT22kHz8BitStereo',
    'DISPID_SABIEventBias', 'DISPID_SABufferInfo', 'SRAExport',
    'SVP_20', 'DISPID_SpeechBaseStream', 'ISpeechRecoContext',
    'SPEI_VOICE_CHANGE', 'SPAS_RUN', 'SPPS_Noun',
    'SpeechVoiceCategoryTTSRate', 'ISpeechLexiconPronunciation',
    'SAFT8kHz8BitStereo', 'STCRemoteServer', 'DISPID_SPACommit',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SGRSTsItem',
    'DISPID_SVEStreamStart', 'DISPID_SRSetPropertyString',
    'DISPID_SVSRunningState', 'DISPID_SRRAlternates',
    'SPEI_SR_BOOKMARK', 'SPSERIALIZEDPHRASE', 'SPWF_SRENGINE',
    'DISPID_SDKSetLongValue', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRInitialState', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechRecoResult',
    'DISPID_SPARecoResult', 'SP_VISEME_10', 'SPEI_RESERVED2',
    'SVPOver', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPIGrammarId', 'SpeechRetainedAudioOptions',
    'SpeechDiscardType', 'SRSEDone',
    'SpeechGrammarRuleStateTransitionType', 'SPINTERFERENCE_NONE',
    'SPWORD', 'DISPID_SGRsCount', 'SpeechStreamSeekPositionType',
    'STSF_LocalAppData', 'SAFT12kHz16BitStereo', 'tagSTATSTG',
    '_SPAUDIOSTATE', 'DISPID_SMSGetData', 'SVP_4', 'SVP_15',
    'SpAudioFormat', 'DISPID_SpeechPhraseElement',
    'DISPID_SRCEAudioLevel', 'SAFT32kHz16BitStereo',
    'SVEWordBoundary', 'STSF_FlagCreate', 'SVF_Stressed',
    'SP_VISEME_5', 'Speech_StreamPos_RealTime', 'SDTAll',
    'SAFTADPCM_44kHzStereo', 'SGDSActive',
    'DISPID_SVSInputWordLength', 'ISpeechPhraseReplacement',
    'SpPhoneConverter', 'SpeechRecognitionType', 'SpeechLexiconType',
    'SVEPhoneme', 'ISpeechRecoResultDispatch', 'SP_VISEME_11',
    'DISPID_SpeechRecoResult2', 'SAFT16kHz8BitMono',
    'SpeechTokenIdUserLexicon', 'DISPID_SRRGetXMLResult',
    'SREStreamEnd', 'SPEI_ADAPTATION', 'DISPID_SGRsCommit',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRDisplayUI',
    'DISPID_SVEBookmark', 'DISPID_SOTCreateInstance',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechMMSysAudio',
    'SpeechCategoryRecognizers', 'DISPID_SDKGetlongValue',
    'DISPID_SPIProperties', 'DISPID_SpeechObjectTokens',
    'SpeechRuleAttributes', 'DISPID_SPEs_NewEnum', 'SPVPRI_NORMAL',
    'SPCS_ENABLED', 'SPPHRASEPROPERTY', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRIsShared', 'ISpeechRecoResult2',
    'DISPID_SRIsUISupported', 'SAFT11kHz8BitMono', 'DISPID_SOTsCount',
    'SASStop', 'DISPID_SRGCommit', 'ISpeechAudio', 'SPVPRI_ALERT',
    'SPEI_SOUND_START', 'eLEXTYPE_PRIVATE11',
    'ISpPhoneticAlphabetSelection', 'SGDisplay', 'SPCT_SLEEP',
    'DISPID_SRGDictationUnload', 'SGDSActiveUserDelimited',
    'SECFEmulateResult', 'SP_VISEME_15', 'DISPID_SBSFormat',
    'SPEI_MIN_TTS', 'SGRSTTDictation', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_PRIVATE12', 'ISpeechPhraseProperties',
    'DISPID_SLPsItem', 'DISPID_SRGState', 'SRTAutopause',
    'SRESoundStart', 'DISPID_SPIRule', 'DISPID_SRRAudio',
    'SPCONTEXTSTATE', 'ISpeechAudioStatus', 'DISPID_SOTCId',
    'ISpeechGrammarRuleStateTransitions', 'UINT_PTR',
    'SpeechEngineProperties', 'SDKLCurrentConfig',
    'ISpeechPhraseInfo', 'SPBO_NONE', 'SPWF_INPUT',
    'eLEXTYPE_RESERVED9', 'eLEXTYPE_PRIVATE2', 'DISPID_SRRTimes',
    'DISPID_SOTsItem', 'SPCT_SUB_DICTATION', 'SVSFlagsAsync',
    'DISPID_SDKEnumValues', 'DISPID_SLPs_NewEnum',
    'SpPhoneticAlphabetConverter', 'STCInprocServer',
    'DISPID_SWFEBitsPerSample', 'SpeechCategoryAudioOut',
    'ISequentialStream', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPAR_Low', 'SPFILEMODE', 'SPBO_AHEAD', 'SRADefaultToActive',
    'DISPID_SVSLastResult', 'DISPID_SpeechVoiceStatus',
    'SRERecognition', 'DISPID_SRCBookmark',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_START_INPUT_STREAM', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SVEEndInputStream', 'SSFMOpenReadWrite',
    'SpeechSpecialTransitionType', 'SGSEnabled', 'SGSExclusive',
    'SVF_None', 'SPEI_RECO_STATE_CHANGE', 'SASPause', 'SPVOICESTATUS',
    'SDTLexicalForm', 'DISPID_SGRSTsCount', 'SVEStartInputStream',
    'SPAR_Medium', 'ISpNotifySink', 'DISPID_SPISaveToMemory',
    'SAFTCCITT_uLaw_8kHzMono', 'SRCS_Enabled', 'DISPID_SPCPhoneToId',
    'SPINTERFERENCE', 'DISPID_SRCRecognizer', 'SpeechAudioVolume',
    'DISPID_SRRGetXMLErrorInfo', 'ISpEventSink',
    'DISPID_SGRSTNextState', 'SBONone', 'SPEI_SR_PRIVATE',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPRFirstElement',
    'DISPID_SPPValue', 'DISPID_SGRSAddRuleTransition',
    'SAFT12kHz8BitMono', 'SpeechRunState', 'DISPID_SRSClsidEngine',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SGRSTs_NewEnum',
    'SAFT12kHz8BitStereo', 'DISPID_SRGReset',
    'DISPID_SRGCmdSetRuleState', 'SITooSlow', 'SPSVerb', 'IStream',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRState',
    'SAFT44kHz8BitStereo', 'eLEXTYPE_PRIVATE19', 'DISPID_SLWsCount',
    'SRTEmulated', 'SPWT_LEXICAL', 'ISpRecoContext2',
    'SPSHORTCUTTYPE', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SVSFParseAutodetect', 'DISPID_SRRSetTextFeedback',
    'SpeechAudioFormatGUIDWave', 'SAFT24kHz16BitStereo',
    'DISPID_SGRSTransitions', 'SAFTADPCM_11kHzMono',
    'DISPID_SPRuleFirstElement', 'SPXRO_Alternates_SML',
    'Speech_Default_Weight', 'ISpRecognizer2', 'ISpeechGrammarRules',
    'SPAR_Unknown', 'DISPID_SVEventInterests',
    'SPEI_PROPERTY_NUM_CHANGE', 'SRTReSent',
    'DISPID_SRAudioInputStream', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRCreateRecoContext', 'SpeechDataKeyLocation',
    'SAFT44kHz8BitMono', 'SpeechGrammarWordType',
    'DISPID_SRGSetWordSequenceData', 'SPAS_STOP',
    'DISPIDSPTSI_ActiveLength',
    'SpeechPropertyLowConfidenceThreshold', 'SpMMAudioOut',
    'ISpLexicon', 'ISpeechPhraseReplacements', 'SPPS_Modifier',
    'SAFT8kHz16BitMono', 'SpeechUserTraining', 'SPSHT_Unknown',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechGrammarRules',
    'SPPS_RESERVED3', 'DISPID_SLAddPronunciation',
    'SpPhraseInfoBuilder', 'DISPID_SRRecognizer', 'SDTProperty',
    'DISPID_SpeechPhraseBuilder', 'SINoise', 'SpeechRuleState',
    'SPFM_CREATE', 'SFTInput', 'SpeechPartOfSpeech', 'SPEVENT',
    'eLEXTYPE_PRIVATE8', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SVP_13', 'SPWORDLIST', 'DISPID_SRCEBookmark',
    'SpeechCategoryAppLexicons', 'SpMMAudioIn', 'DISPID_SOTs_NewEnum',
    'SAFT8kHz8BitMono', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPPName',
    'SpeechVoiceSkipTypeSentence', 'SPXRO_SML'
]
