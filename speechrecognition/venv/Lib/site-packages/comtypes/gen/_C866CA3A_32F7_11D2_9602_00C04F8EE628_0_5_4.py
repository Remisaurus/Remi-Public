...
__all__ = [
    'SP_VISEME_0', 'DISPID_SpeechPhraseBuilder', 'ISpLexicon',
    'ISpeechTextSelectionInformation', 'SPEI_TTS_AUDIO_LEVEL',
    'SVEPhoneme', 'SGSDisabled', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRGetPropertyString', 'SREPropertyNumChange',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE1',
    'SPEI_RESERVED3', 'SpNullPhoneConverter',
    'DISPID_SPEAudioStreamOffset', 'SAFT12kHz16BitMono',
    'SAFTADPCM_22kHzMono', 'SLOStatic', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechLexiconProns', 'DISPID_SOTsCount', 'SpMemoryStream',
    'SPPHRASEREPLACEMENT', 'SDTAlternates',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVSVisemeId', 'SPAR_Low',
    'SpeechTokenContext', 'SPVPRIORITY',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'tagSTATSTG',
    'SECHighConfidence', 'SASStop', 'SVP_7', 'SVEStartInputStream',
    'DISPID_SPERequiredConfidence', 'SGDisplay', 'SP_VISEME_14',
    'ISpeechAudio', 'SWPUnknownWordPronounceable',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRGCmdLoadFromMemory', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechRecoResult2', 'DISPID_SOTGetAttribute',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPAStartElementInResult',
    'ISpProperties', 'DISPID_SPPsItem', 'ISpNotifySink',
    'SAFTCCITT_ALaw_8kHzMono', 'SVP_8', 'SAFTADPCM_11kHzMono',
    'DISPID_SOTsItem', 'SVSFVoiceMask', 'SPPS_NotOverriden',
    'DISPID_SLPLangId', 'SSFMCreate', 'DISPID_SOTCDefault',
    'SpeechSpecialTransitionType', 'STCInprocHandler',
    'SpeechPropertyResponseSpeed', 'SVP_13', 'DISPID_SABufferInfo',
    'ISpeechGrammarRuleStateTransition', 'SPINTERFERENCE',
    'SPEI_START_SR_STREAM', 'DISPID_SADefaultFormat',
    'SREFalseRecognition', 'DISPID_SVSCurrentStreamNumber',
    'SAFT48kHz8BitMono', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPEPronunciation',
    'DISPID_SLGenerationId', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPPEngineConfidence',
    'DISPID_SASNonBlockingIO', 'DISPID_SRGCmdSetRuleState',
    'SAFT22kHz16BitMono', 'SVP_19', 'DISPID_SRSNumberOfActiveRules',
    '_ISpeechVoiceEvents', 'ISpeechLexiconWord',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCEStartStream',
    'SVPNormal', 'LONG_PTR', 'SPVPRI_NORMAL', 'SPSMF_SAPI_PROPERTIES',
    'SSFMOpenForRead', 'SLTUser', 'ISpRecoCategory',
    'DISPID_SPRules_NewEnum', 'DISPID_SVEEnginePrivate',
    'DISPID_SPRuleParent', 'SVP_6', 'DISPID_SGRSTPropertyValue',
    'SAFT32kHz8BitMono', 'SpeechRuleState',
    'DISPID_SVSInputWordLength', 'SPFM_OPEN_READONLY',
    'DISPID_SVSLastBookmark', 'SPWORDPRONUNCIATION', 'SPBO_NONE',
    'SAFTADPCM_8kHzMono', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRGSetWordSequenceData', 'ISpeechPhraseReplacements',
    'DISPID_SVGetVoices', 'SGSExclusive', 'SPCT_SLEEP',
    'eLEXTYPE_PRIVATE15', 'SRERecognition',
    'DISPID_SPERetainedStreamOffset', 'SDTReplacement',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_RESERVED10',
    'SPXRO_Alternates_SML', 'SPAUDIOOPTIONS', 'SPFILEMODE',
    'DISPID_SPIRule', 'SPAUDIOSTATUS', 'SpeechAllElements',
    'DISPID_SRIsShared', 'SPTEXTSELECTIONINFO', 'SAFT8kHz16BitStereo',
    'DISPID_SGRsCount', 'SpeechCategoryPhoneConverters',
    'ISpRecoContext', 'DISPID_SRRRecoContext', 'DISPID_SRGetFormat',
    'SITooQuiet', 'SRTStandard', 'SpeechRecoContextState',
    'DISPID_SVSRunningState', 'DISPID_SPRuleConfidence',
    'SPRS_INACTIVE', 'SPDKL_CurrentUser', 'ISpeechGrammarRuleState',
    'DISPID_SOTCGetDataKey', 'DISPID_SPEDisplayText',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRRSetTextFeedback',
    'SPEI_VOICE_CHANGE', 'SRSEDone', 'DISPID_SRCCreateGrammar',
    'eLEXTYPE_PRIVATE8', 'SpeechRecognitionType', 'DISPID_SRRTLength',
    'Speech_StreamPos_RealTime', 'ISpeechMemoryStream', 'SVP_21',
    'ISpeechRecognizer', 'SECFIgnoreCase', 'SpInProcRecoContext',
    'SAFT8kHz16BitMono', 'SpeechPropertyHighConfidenceThreshold',
    'ISpRecognizer3', 'eLEXTYPE_RESERVED8', 'SPSSuppressWord',
    'ISpeechPhraseInfoBuilder', 'SLTApp', 'DISPID_SPRuleFirstElement',
    'SPRST_ACTIVE', 'DISPID_SVESentenceBoundary',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechDataKey',
    'DISPID_SPPNumberOfElements', 'DISPID_SVSpeakStream',
    'SpeechDisplayAttributes', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRRAudioFormat', 'ISpeechGrammarRule', '_RemotableHandle',
    'SpeechBookmarkOptions', 'ISpeechObjectToken',
    'ISpeechPhraseRules', 'SASRun', 'SAFT12kHz8BitStereo',
    'SPFM_OPEN_READWRITE', 'DISPID_SRAudioInputStream', 'SPEI_MAX_SR',
    'SRAExport', 'SpLexicon', 'eLEXTYPE_RESERVED9', 'SITooLoud',
    'DISPID_SMSGetData', 'SRTExtendableParse', 'SP_VISEME_19',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVEPhoneme',
    'DISPID_SpeechFileStream', 'SAFTNonStandardFormat',
    'DISPID_SLGetWords', 'SBOPause', 'IInternetSecurityManager',
    'SpeechRegistryUserRoot', 'DISPID_SpeechAudioFormat',
    'SP_VISEME_7', 'DISPID_SPEEngineConfidence',
    'DISPID_SRGRecoContext', 'DISPID_SRProfile',
    'DISPID_SpeechPhraseElements', 'ISpRecoContext2',
    'SVEVoiceChange', 'SAFT24kHz16BitStereo', 'DISPID_SVEStreamStart',
    'DISPID_SVAudioOutput', 'SPEI_MIN_TTS', 'SPEI_RESERVED2',
    'WAVEFORMATEX', 'SVSFPersistXML', 'SpeechVisemeType',
    'DISPID_SpeechAudio', 'SWTDeleted', 'SPCT_DICTATION',
    'SpPhoneticAlphabetConverter', 'DISPID_SVRate', 'DISPID_SGRClear',
    'SPRECOSTATE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpeechPhraseRule', 'SAFTText', 'SP_VISEME_17',
    ...
    'ISpeechCustomStream', 'DISPID_SPRText', 'SP_VISEME_8',
    'DISPID_SpeechRecoContext', 'SPPS_LMA', 'SpCompressedLexicon',
    'SPEVENTENUM', 'SPEI_MIN_SR', 'DISPID_SRCRecognizer',
    'DISPID_SRGDictationLoad', 'DISPID_SRCERequestUI',
    'SVSFParseAutodetect', 'DISPID_SGRsCommit',
    'Speech_Max_Word_Length', 'ISpObjectWithToken',
    ...
    'DISPID_SPRuleNumberOfElements', 'SVSFIsXML', 'SPEI_PHONEME',
    ...
    'SVP_16', 'DISPID_SPRuleChildren', 'DISPID_SABIBufferSize',
    'SP_VISEME_16', 'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRGReset',
    'SRADefaultToActive', 'DISPID_SRCERecognitionForOtherContext',
    'SDKLDefaultLocation', 'SVP_14', 'SpeechVoiceCategoryTTSRate',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SABIMinNotification',
    'eLEXTYPE_PRIVATE13', 'SLODynamic', 'DISPID_SpeechLexiconWord',
    ...
    'SpeechStreamSeekPositionType', 'DISPID_SRCResume',
    'ISpeechBaseStream', 'SPADAPTATIONRELEVANCE', 'SP_VISEME_12',
    'SpeechGrammarTagWildcard', 'SpeechVisemeFeature',
    'DISPID_SRRGetXMLErrorInfo', 'ISpGrammarBuilder',
    'STCRemoteServer', 'SVP_15', 'SVEWordBoundary',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechVoiceEvent',
    'DISPID_SOTMatchesAttributes', 'SSTTDictation',
    'DISPID_SRCESoundStart', 'SVESentenceBoundary', 'SPLO_STATIC',
    'ISpNotifyTranslator', 'SPPS_RESERVED3',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechTokenKeyFiles',
    'DISPID_SPRuleId', 'SPXRO_SML', 'SPEI_SR_BOOKMARK',
    'DISPID_SRGCmdSetRuleIdState', 'SVEAudioLevel', 'SRSActive',
    'SPPHRASE', 'SPEI_RESERVED5', 'SVSFUnusedFlags', 'SGSEnabled',
    'SPSInterjection', 'SpObjectToken',
    ...
    'DISPID_SVStatus', 'SDTAudio', 'DISPID_SVEAudioLevel',
    'DISPID_SRCEventInterests', 'DISPID_SRCPause',
    'SPAO_RETAIN_AUDIO', 'DISPID_SOTCSetId', 'ISpRecoGrammar',
    'SAFT16kHz8BitStereo', 'SPRECORESULTTIMES',
    'DISPID_SRGCmdLoadFromObject', 'SPSHT_NotOverriden',
    'DISPID_SPPs_NewEnum', 'SVP_1', 'DISPID_SGRSRule',
    'DISPID_SPIReplacements', 'DISPID_SDKGetStringValue',
    'DISPID_SVPause', 'DISPID_SpeechXMLRecoResult', 'SPVISEMES',
    'IEnumSpObjectTokens', 'SRTAutopause', 'SPGRAMMARWORDTYPE',
    'DISPID_SAEventHandle', 'DISPID_SBSRead', 'SPSEMANTICERRORINFO',
    'SRCS_Disabled', 'SP_VISEME_2', 'SP_VISEME_18',
    'SAFT48kHz8BitStereo', 'SVP_9', 'DISPID_SASCurrentSeekPosition',
    'DISPIDSPTSI_SelectionLength', 'SVEViseme', 'DISPID_SLWs_NewEnum',
    'SPSHT_Unknown', 'DISPID_SGRSTPropertyName', 'DISPID_SRRTimes',
    'ISpeechRecoResultDispatch', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpSharedRecoContext', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SGRSTs_NewEnum', 'SPSHT_EMAIL', 'ISpDataKey',
    'SPCT_SUB_DICTATION', 'DISPID_SDKOpenKey',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTText',
    'ISpeechRecoGrammar', 'SPSERIALIZEDRESULT', 'DISPID_SAVolume',
    'SAFT11kHz16BitStereo', 'ISpStreamFormatConverter',
    'SSTTWildcard', 'Speech_Max_Pron_Length', 'SDA_No_Trailing_Space',
    'SPWT_LEXICAL', 'eWORDTYPE_DELETED', 'SPEI_REQUEST_UI',
    'SpCustomStream', 'ISpXMLRecoResult', 'DISPID_SVVoice',
    'DISPID_SRCEFalseRecognition', 'SGLexicalNoSpecialChars',
    'DISPID_SPPName', 'SAFT44kHz16BitStereo', 'DISPIDSPRG',
    'SAFT16kHz16BitMono', 'DISPID_SVSLastBookmarkId',
    'DISPID_SFSOpen', 'SPPARTOFSPEECH', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRRAlternates',
    'DISPID_SGRsAdd', 'SPRS_ACTIVE', 'DISPID_SpeechRecognizerStatus',
    'ISpeechRecoResultTimes', 'eLEXTYPE_RESERVED7',
    'DISPID_SRRTTickCount', 'SAFTTrueSpeech_8kHz1BitMono', 'SPSVerb',
    'SPAO_NONE', 'tagSPTEXTSELECTIONINFO', 'SPBO_PAUSE',
    'SPEI_RECO_STATE_CHANGE', 'SpeechVoiceSpeakFlags',
    'tagSPPROPERTYINFO', 'ISpeechPhraseReplacement',
    'SpeechCategoryAudioIn', 'SRARoot', 'SPBO_AHEAD',
    'DISPID_SOTs_NewEnum', 'SPVPRI_OVER', 'SPWORD',
    'DISPID_SVPriority', 'DISPID_SRCEBookmark', 'SPSLMA',
    'DISPID_SRSCurrentStreamNumber', 'SITooFast',
    'DISPID_SRGetPropertyNumber', 'SPDATAKEYLOCATION',
    'SPPS_SuppressWord', 'DISPID_SRIsUISupported', 'SGDSInactive',
    'SPSHORTCUTPAIR', 'DISPID_SRSClsidEngine', 'SWTAdded',
    'DISPID_SVSInputSentencePosition', 'SpeechCategoryVoices',
    'SPEI_INTERFERENCE', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPPS_Interjection', 'ISpeechResourceLoader',
    'ISpPhoneticAlphabetConverter', 'SVF_None', 'SECFEmulateResult',
    'SWPKnownWordPronounceable', 'DISPID_SRGSetTextSelection',
    'SFTInput', 'SPLOADOPTIONS', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVAudioOutputStream', 'SPGRAMMARSTATE', 'ISpVoice',
    'SPSUnknown', 'DISPID_SpeechAudioBufferInfo', 'SPEI_ADAPTATION',
    'DISPID_SRCRetainedAudioFormat', 'SPAUDIOSTATE',
    'DISPID_SRGetRecognizers', 'SpeechAudioVolume',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPRuleName', 'SPSNoun',
    'DISPID_SPARecoResult', 'DISPID_SLAddPronunciation',
    'DISPID_SGRAddResource', 'DISPID_SpeechPhraseProperty',
    'SPSNotOverriden', 'SDTDisplayText', 'DISPID_SCSBaseStream',
    'SpeechAddRemoveWord', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT11kHz16BitMono',
    'ISpeechRecoContext', 'SPPS_Unknown', 'DISPID_SRCEEndStream',
    'DISPID_SAFSetWaveFormatEx', 'SPEI_SOUND_END', 'ISpObjectToken',
    'SSSPTRelativeToEnd', 'SpeechPartOfSpeech', 'SREHypothesis',
    'SPVOICESTATUS', 'DISPID_SPIGrammarId', 'DISPID_SRRAudio',
    'DISPID_SVVolume', 'DISPID_SDKGetBinaryValue', 'SpFileStream',
    'SPAS_RUN', 'SPPS_RESERVED1', '_ISpeechRecoContextEvents',
    'SDKLCurrentUser', 'DISPID_SRGState', 'ISpPhrase', 'SDTProperty',
    'SAFTADPCM_11kHzStereo', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SGRSTNextState', 'DISPID_SOTId', 'SECLowConfidence',
    'SAFTGSM610_22kHzMono', 'SP_VISEME_21', 'ISpeechPhraseProperty',
    'SpeechTokenKeyUI', 'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechLexiconPronunciation', 'SVP_0', 'eLEXTYPE_USER',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_PRIVATE5',
    'SpeechEngineProperties', 'SpeechTokenKeyAttributes',
    'STCLocalServer', 'DISPID_SRCSetAdaptationData', 'SREPhraseStart',
    'SPBO_TIME_UNITS', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechAudioStatus', 'DISPID_SFSClose',
    'SAFT8kHz8BitStereo', 'DISPID_SAStatus',
    'SSSPTRelativeToCurrentPosition', 'SpeechCategoryRecoProfiles',
    'DISPID_SOTCId', 'DISPID_SLPPartOfSpeech', 'DISPID_SPCPhoneToId',
    'ISpRecognizer2', 'eLEXTYPE_PRIVATE14', 'DISPID_SAFType',
    'SPSTREAMFORMATTYPE', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRST_INACTIVE', 'SRSEIsSpeaking', 'SRAORetainAudio',
    'STCInprocServer', 'DISPID_SPILanguageId', 'DISPID_SPPConfidence',
    'SPSHORTCUTPAIRLIST', 'SpeechRecoEvents', 'SITooSlow',
    'DISPID_SLWsItem', 'IEnumString', 'SPGS_EXCLUSIVE',
    'SPRECOGNIZERSTATUS', 'SPWT_DISPLAY', 'DISPID_SpeechVoiceStatus',
    'SSFMCreateForWrite', 'SRESoundEnd', 'SDKLCurrentConfig',
    'ISpeechPhraseAlternates', 'DISPID_SVGetAudioInputs',
    'ISpeechMMSysAudio', 'SREStreamStart', 'SpeechTokenValueCLSID',
    'DISPID_SRCERecognition', 'SpeechInterference',
    'SAFTGSM610_11kHzMono', 'SpeechDataKeyLocation',
    'DISPID_SpeechRecognizer', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE7', 'SpObjectTokenCategory',
    'DISPID_SRGCmdLoadFromResource', 'SpeechLexiconType',
    'SPWORDLIST', 'DISPID_SOTDataKey',
    'DISPID_SpeechRecoContextEvents', 'SGRSTTTextBuffer',
    'SRSActiveAlways', 'SpeechLoadOption', 'eLEXTYPE_PRIVATE16',
    'DISPID_SVSLastStreamNumberQueued', 'SREInterference',
    'SDTLexicalForm', 'eLEXTYPE_PRIVATE17', 'SAFT32kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'SpeechPropertyAdaptationOn',
    'ISequentialStream', 'SPPROPERTYINFO', 'SDA_One_Trailing_Space',
    'SPEVENT', 'DISPID_SpeechBaseStream', 'SSSPTRelativeToStart',
    'DISPID_SBSSeek', 'SAFTADPCM_8kHzStereo', 'SpPhoneConverter',
    'ISpRecoResult', 'SREStateChange', 'eLEXTYPE_PRIVATE4',
    'UINT_PTR', 'SECFIgnoreWidth', 'ISpeechVoiceStatus',
    'DISPID_SPIGetText', 'SPCONTEXTSTATE', 'ISpAudio',
    'SVEEndInputStream', 'SVP_11',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpStreamFormat',
    'DISPID_SRCESoundEnd', 'DISPID_SPAsCount', 'DISPID_SPPChildren',
    'SPXMLRESULTOPTIONS', 'SPSFunction',
    'SpeechPropertyResourceUsage', 'SVP_17', 'DISPID_SLPs_NewEnum',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPIAudioSizeBytes',
    'SpeechRetainedAudioOptions', 'SAFT24kHz8BitMono',
    'SPPS_RESERVED2', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechRecoResultTimes', 'SVP_3', 'DISPID_SVEViseme',
    'SpeechWordType', 'eLEXTYPE_PRIVATE2',
    'DISPID_SAFGetWaveFormatEx', 'SpeechGrammarTagUnlimitedDictation',
    'eLEXTYPE_PRIVATE18', 'SPEI_PHRASE_START', 'SVP_12',
    'DISPID_SDKDeleteValue', 'DISPID_SOTGetDescription', 'SRADynamic',
    'SPSModifier', 'SSFMOpenReadWrite', 'DISPID_SRRSaveToMemory',
    'DISPID_SPRFirstElement', 'DISPID_SRSetPropertyString',
    'SpAudioFormat', 'DISPID_SPCIdToPhone', 'SPEI_UNDEFINED',
    'DISPID_SRAudioInput', 'DISPID_SGRs_NewEnum', '_SPAUDIOSTATE',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SWFEFormatTag',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPRs_NewEnum', 'SREAllEvents',
    'SP_VISEME_4', 'DISPIDSPTSI', 'DISPID_SRCEAudioLevel',
    'SAFTDefault', 'ISpeechRecoResult', 'SpeechRecoProfileProperties',
    'DISPID_SpeechLexicon', 'SpeechRecognizerState',
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRSTransitions',
    'DISPID_SRCBookmark', 'SVF_Emphasis', 'DISPID_SOTRemove',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechPhoneConverter',
    'DISPID_SGRSAddWordTransition', 'ISpRecoGrammar2', 'SVEPrivate',
    'SPEI_RECOGNITION', 'DISPID_SRGDictationUnload',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRInitialState',
    'DISPID_SRGCommit', 'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPRsItem',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechWaveFormatEx', 'SVP_20',
    'DISPID_SRGRules', 'DISPID_SpeechObjectTokenCategory',
    'SPEI_END_INPUT_STREAM', 'DISPID_SGRsFindRule',
    'SVSFPurgeBeforeSpeak', 'SAFT24kHz16BitMono', 'SPAS_STOP',
    ...
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SBSFormat', 'SVSFNLPSpeakPunc',
    'SPGS_ENABLED', 'SpStreamFormatConverter',
    'DISPID_SDKSetStringValue', 'SpWaveFormatEx',
    'Speech_Default_Weight', 'SPEI_WORD_BOUNDARY', 'SGRSTTEpsilon',
    'SPEI_RESERVED6', 'DISPID_SpeechPhraseElement',
    'DISPID_SMSALineId', 'DISPID_SMSSetData', 'SPSERIALIZEDPHRASE',
    'SINone', 'ISpeechXMLRecoResult', 'DISPID_SPAsItem', 'SINoise',
    'ISpeechPhraseInfo', 'DISPID_SOTCreateInstance', 'SpMMAudioIn',
    'DISPID_SPELexicalForm', 'SGRSTTDictation', 'SVSFDefault',
    'ISpeechPhraseProperties', 'DISPID_SVEWord',
    'DISPID_SRCRetainedAudio', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechDictationTopicSpelling', 'DISPID_SPIStartTime',
    'DISPID_SPAPhraseInfo', 'ISpeechPhraseElements',
    'DISPID_SPEs_NewEnum', 'SPCS_DISABLED', 'DISPID_SRCState',
    'DISPIDSPTSI_ActiveOffset', 'SpStream', 'SPVPRI_ALERT',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRRTStreamTime',
    'SGRSTTWildcard', 'DISPID_SOTDisplayUI', 'SRCS_Enabled',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_START_INPUT_STREAM',
    'SPEI_TTS_PRIVATE', 'DISPID_SPPFirstElement',
    'SAFTADPCM_44kHzMono', 'SVSFIsNotXML', 'DISPID_SGRsItem',
    'SECFNoSpecialChars', 'SpeechGrammarState',
    'DISPID_SABufferNotifySize',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechLexiconWords', 'SPFM_NUM_MODES', 'DISPID_SGRSTRule',
    'SpeechStreamFileMode', 'SAFT48kHz16BitMono', 'SPGS_DISABLED',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechCustomStream',
    'DISPID_SRCEPhraseStart', 'SAFT22kHz8BitMono', 'SVPAlert',
    'DISPID_SVGetAudioOutputs', 'SVSFParseSapi',
    'DISPID_SpeechMMSysAudio', 'SPRST_NUM_STATES', 'SDKLLocalMachine',
    'SpeechDiscardType', 'DISPID_SGRSTsCount', 'SPWORDTYPE',
    'SPEI_RECO_OTHER_CONTEXT', 'SRERequestUI', 'SVP_10',
    'SpeechAudioState', 'DISPID_SLWLangId',
    'DISPID_SLWPronunciations', 'SPEI_RESERVED1',
    'DISPID_SPRulesCount', 'SGDSActive',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechGrammarRules',
    'DISPID_SRGCmdLoadFromFile', 'SAFTGSM610_8kHzMono',
    'SpeechVoiceEvents', 'SAFTCCITT_ALaw_44kHzStereo', 'SGRSTTWord',
    'SRAONone', 'eLEXTYPE_PRIVATE6', 'SSTTTextBuffer',
    'DISPID_SRCEHypothesis', 'eLEXTYPE_MORPHOLOGY',
    'IInternetSecurityMgrSite', 'DISPID_SOTSetId',
    'DISPID_SPRulesItem', 'ISpStream', 'SGDSActiveUserDelimited',
    'SVP_5', 'DISPID_SVEVoiceChange', 'SAFT22kHz16BitStereo',
    'SPBOOKMARKOPTIONS', 'SP_VISEME_11', 'ISpeechAudioStatus',
    'ISpShortcut', 'eLEXTYPE_PRIVATE20', 'SPRULESTATE',
    'DISPID_SPCLangId', 'DISPID_SGRSAddRuleTransition',
    'SpResourceManager', 'ISpeechVoice', 'SAFT16kHz8BitMono',
    'DISPID_SPPValue', 'SpeechRuleAttributes',
    'DISPID_SpeechPhraseRule', 'Speech_StreamPos_Asap',
    'DISPID_SVResume', 'SVP_18', 'SPBINARYGRAMMAR',
    'eLEXTYPE_PRIVATE9', 'SVSFIsFilename', 'SPAR_Unknown',
    'DISPID_SRState', 'SpeechFormatType',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCreateRecoContext', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPPsCount', 'SRTReSent', 'SAFT32kHz16BitStereo',
    'SPEI_HYPOTHESIS', 'DISPID_SLWType', 'SPWF_SRENGINE',
    'DISPID_SDKCreateKey', 'SpMMAudioOut', 'DISPID_SRRecognizer',
    'SPEI_VISEME', 'SPEI_MAX_TTS', 'SPWORDPRONOUNCEABLE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEEnginePrivate',
    'SRESoundStart', 'SPAR_Medium', 'SGLexical', 'DISPID_SLPsItem',
    'SASClosed', 'SAFT44kHz16BitMono', 'SPFM_CREATE',
    'STSF_CommonAppData', 'SpeechCategoryAppLexicons',
    ...
    'SVSFlagsAsync', 'SP_VISEME_20', 'DISPID_SRSAudioStatus',
    'SPLEXICONTYPE', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVAlertBoundary',
    'SAFT16kHz16BitStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPEActualConfidence', 'DISPID_SBSWrite',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechDataKey',
    'DISPID_SPEAudioSizeBytes', 'SPPHRASEELEMENT',
    'DISPID_SpeechObjectTokens', 'DISPID_SLPPhoneIds',
    'SPRST_INACTIVE_WITH_PURGE', 'SPPS_Noun', 'DISPID_SPEsCount',
    'ISpeechWaveFormatEx', 'SpMMAudioEnum', 'SpeechWordPronounceable',
    'eLEXTYPE_RESERVED4', 'SVEBookmark', 'SAFTCCITT_uLaw_44kHzMono',
    'SBONone', 'DISPID_SVSpeak', 'DISPID_SWFEBlockAlign',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVEventInterests',
    'SpeechCategoryAudioOut', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRCEAdaptation', 'DISPID_SpeechPhraseAlternate',
    'ISpObjectTokenCategory', 'SpShortcut',
    'SpeechAudioFormatGUIDWave', 'SRTEmulated', 'DISPID_SLPType',
    'SVP_2', 'SRTSMLTimeout', 'STCAll',
    'DISPID_SPIGetDisplayAttributes', 'SDTPronunciation',
    'SAFT32kHz16BitMono', 'SAFT11kHz8BitMono', 'SECFDefault',
    'SASPause', 'ISpPhraseAlt', 'DISPID_SLGetGenerationChange',
    'DISPID_SDKDeleteKey', 'ISpMMSysAudio', 'ISpeechObjectTokens',
    'SVP_4', 'SPPHRASERULE', 'SPPS_Modifier', 'SPEI_SOUND_START',
    'SAFT12kHz16BitStereo', 'DISPID_SpeechRecoResult',
    'DISPID_SGRSTWeight', 'ISpeechAudioBufferInfo', 'DISPID_SVSkip',
    'SINoSignal', 'DISPID_SRRGetXMLResult',
    'DISPID_SpeechPhraseReplacements', 'ISpEventSource',
    'DISPID_SOTIsUISupported', 'SRAImport',
    'DISPID_SASFreeBufferSpace', 'SpeechGrammarTagDictation',
    'DISPID_SRCCmdMaxAlternates', 'eLEXTYPE_APP', 'SREAdaptation',
    'ISpeechAudioFormat', 'SRSInactiveWithPurge',
    'SpeechEngineConfidence', 'DISPID_SABIEventBias', 'SPPS_Verb',
    'DISPID_SDKSetLongValue', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPWF_INPUT', 'SPINTERFERENCE_TOOLOUD', 'SpeechAudioProperties',
    'DISPID_SPIProperties', 'DISPID_SRStatus', 'ISpeechPhraseElement',
    'DISPID_SpeechPhraseAlternates', 'SAFT24kHz8BitStereo',
    'DISPID_SLPsCount', 'DISPID_SPIAudioStreamPosition',
    'eLEXTYPE_RESERVED6', 'SAFTExtendedAudioFormat', 'SGRSTTRule',
    'SPSEMANTICFORMAT', 'SPCT_COMMAND', 'SP_VISEME_10',
    'ISpeechFileStream', 'SpeechVoicePriority',
    'SpeechTokenShellFolder', 'DISPID_SMSADeviceId',
    'DISPID_SGRAttributes', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVSPhonemeId', 'ISpNotifySource', 'SAFT8kHz8BitMono',
    'DISPID_SRRPhraseInfo', 'SpeechCategoryRecognizers', 'SDTRule',
    'SpeechMicTraining', 'DISPID_SDKEnumValues',
    'SpTextSelectionInformation', 'DISPID_SRCEPropertyStringChange',
    'SAFT12kHz8BitMono', 'SRAInterpreter', 'SpUnCompressedLexicon',
    'eLEXTYPE_PRIVATE19', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPWAVEFORMATTYPE', 'DISPID_SGRsDynamic', 'STSF_AppData',
    'SAFTNoAssignedFormat', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SDKSetBinaryValue', 'SVEAllEvents', 'ISpRecognizer',
    'DISPID_SGRId', 'SPPS_Function', 'SPPS_RESERVED4',
    ...
    'ISpPhoneticAlphabetSelection', 'SPEI_SR_PRIVATE',
    'DISPID_SDKGetlongValue', 'DISPID_SRSSupportedLanguages',
    'DISPID_SWFEAvgBytesPerSec', 'SP_VISEME_1',
    'DISPID_SPISaveToMemory', 'SGPronounciation', 'DISPID_SRCVoice',
    'SPSMF_UPS', 'DISPID_SPIElements', 'DISPID_SVEStreamEnd',
    'SPPHRASEPROPERTY', 'SpPhraseInfoBuilder',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRAddState', 'SP_VISEME_3',
    'DISPID_SPERetainedSizeBytes', 'SPINTERFERENCE_NONE',
    'DISPID_SRDisplayUI', 'SREPropertyStringChange',
    'DISPID_SLWsCount', 'SPDKL_LocalMachine', 'ISpSerializeState',
    'SPDKL_CurrentConfig', 'SpeechEmulationCompareFlags',
    'DISPID_SPEAudioTimeOffset', 'ISpResourceManager', 'SREStreamEnd',
    'SPAS_CLOSED', 'DISPID_SPRNumberOfElements', 'SPWT_PRONUNCIATION',
    'STSF_FlagCreate', 'DISPID_SGRSTType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_9',
    'DISPID_SRCEInterference', 'DISPID_SVDisplayUI', 'SPCATEGORYTYPE',
    'SAFT22kHz8BitStereo', 'DISPID_SPEsItem', 'SpInprocRecognizer',
    'DISPID_SASetState', 'DISPID_SPRsCount', 'DISPID_SGRName',
    'SGDSActiveWithAutoPause', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVSInputWordPosition', 'SPLO_DYNAMIC',
    'ISpeechRecoResult2', 'eWORDTYPE_ADDED', 'SAFT44kHz8BitMono',
    'DISPID_SWFEExtraData', 'DISPID_SVWaitUntilDone',
    'ISpeechLexiconPronunciations', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPId', 'SPEI_TTS_BOOKMARK', 'DISPID_SOTCategory',
    'SPEI_END_SR_STREAM', 'SAFT11kHz8BitStereo',
    'DISPID_SRCRequestedUIType', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPIAudioSizeTime', 'ISpeechPhraseAlternate',
    'DISPID_SAFGuid', 'SVSFParseMask', 'DISPID_SpeechObjectToken',
    'ISpeechLexicon', 'SP_VISEME_13', 'SpeechUserTraining',
    'SpeechVoiceSkipTypeSentence', 'SPRULE', 'SREAudioLevel',
    'SP_VISEME_5', 'SDA_Two_Trailing_Spaces', 'DISPID_SASState',
    'DISPID_SVGetProfiles', 'DISPID_SPIEngineId', 'SRSInactive',
    ...
    'SpSharedRecognizer', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPS_Noncontent', 'DISPID_SpeechGrammarRules', 'SVF_Stressed',
    'SVSFParseSsml', 'SPSHORTCUTTYPE', 'DISPID_SVSLastResult',
    'SP_VISEME_15', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGId', 'SVPOver',
    'SPAR_High', 'DISPID_SPAs_NewEnum', '__MIDL_IWinTypes_0009',
    'SPAUDIOBUFFERINFO', 'DISPID_SVEBookmark', 'IStream',
    'ISpPhoneConverter', 'SpeechAudioFormatGUIDText', 'SREBookmark',
    'SRATopLevel', 'SAFT48kHz16BitStereo', 'DISPID_SpeechVoice',
    'DISPID_SPACommit', 'SPAS_PAUSE', 'ISpeechRecognizerStatus',
    'SpeechAudioFormatType', 'SDTAll', 'SECNormalConfidence',
    'SPSHT_OTHER', 'SP_VISEME_6', 'SFTSREngine',
    'ISpeechLexiconWords', 'SAFTGSM610_44kHzMono',
